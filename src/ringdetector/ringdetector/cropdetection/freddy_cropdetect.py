...
DatasetCatalog.register(name, lambda d="train": ds.generate_dataset(d, "outerInner", False))
...
cfg.SOLVER.MAX_ITER = 150  # 300 iterations seems good enough for this toy dataset; you will need to train longer for a practical dataset
