...
def draw_all_ImageAnnotations(annotation: Image_Annotation):
    image = cv2.imread(
        os.path.join("/Users/fredericboesel/Documents/master/frühling22/ds_lab/data/labels", annotation.image_path))
